...
## Project Structure
    ...
    ├── test_template_chat__40093  # Django project configurations
...
1. Clone this repo and `cd test_template_chat__40093`
...
2. Clone this repo and `cd test_template_chat__40093`
